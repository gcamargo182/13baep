    ...
    <div class="container">
        <div class="row align-items-center gap-7 gap-xl-0">
            ...
            <div class="col-xl-7" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
                ...
                <h2 class="mb-2">Nome do Policial</h2>
            ...
            <div class="col-xl-5 text-center" data-aos="fade-left" data-aos-delay="100" data-aos-duration="1000">
                <div class="position-relative d-inline-block" style="padding: 0 20px 20px 0;">
                    ...
                    <div class="position-absolute bottom-0 end-0" style="width:92%; height:92%; border-radius:20px; background-color:rgba(233, 191, 23, 0.8); z-index:0;">
                    </div>
                    {{-- Foto --}}
                    <img src="{{ asset('images/policialmes/silhueta3x4.jpg') }}" alt="Policial do Mês" class="img-fluid position-relative" style="border-radius:16px; z-index:1; max-height:520px; width:100%; object-fit:cover; object-position: top center; box-shadow: 0 8px 32px rgba(0,0,0,0.18);">
                </div>
            </div>
